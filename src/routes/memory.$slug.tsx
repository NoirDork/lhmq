...
> = {
  "university-memories": {
    ...
    detail: "The university years were a whirlwind of new experiences. From the very first lecture hall to the final exam, every day brought something new — friendships, knowledge, challenges, and triumphs. The library sessions, the group projects, the cafeteria laughs — all of it built the foundation for who I've become.",
  ...
  "friends-classmates": {
    ...
    detail: "None of this would have been the same without the incredible people I met along the way. Classmates who became study partners, then became friends, then became family. The shared stress before exams, the celebrations after deadlines, and the countless memories in between — these bonds will last a lifetime.",
  ...
  "graduation-moments": {
    ...
    detail: "Walking across that stage, diploma in hand, was the culmination of years of dedication. The applause, the cheers from family in the crowd, the weight of the graduation gown — every second was surreal. This is the moment we all worked toward, and it was everything we dreamed it would be.",
  ...
  "behind-the-journey": {
    ...
    detail: "What you see on graduation day is just the tip of the iceberg. Behind every cap and gown are countless all-nighters, moments of doubt, pages of notes, cups of coffee, and the quiet determination to keep going when things got hard. This journey taught me resilience, patience, and the value of hard work.",
  ...
  "family-support": {
    ...
    detail: "My family has been my anchor through it all. From the late-night pep talks to the unwavering belief in my potential, they never let me give up. They celebrated my small victories and lifted me during my low moments. This diploma is as much theirs as it is mine.",
  ...
  "new-beginning": {
    ...
    detail: "Graduation isn't just an ending — it's a doorway to everything that comes next. Armed with knowledge, memories, and the support of those who believed in me, I'm ready to step into the world and build the future. The best is yet to come.",
